...
[`cookbooks/04-agents/01-the-agent-loop/`](../01-the-agent-loop/)](../01-the-agent-loop/) writes the loop by hand: call the model, read
...
*The comparison is with [`cookbooks/04-agents/01-the-agent-loop/`](../01-the-agent-loop/)](../01-the-agent-loop/), where
...
- [`cookbooks/04-agents/01-the-agent-loop/`](../01-the-agent-loop/)](../01-the-agent-loop/) — the loop this replaces, which is still
